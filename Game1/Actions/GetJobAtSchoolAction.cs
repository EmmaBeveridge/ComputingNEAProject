...
{
    /// <summary>
    /// Inherits from ActionAbstract to implement action to get a job at the school
    /// </summary>
    class GetJobAtSchoolAction : ActionAbstract
    {
        /// <summary>
        /// Constructor to create a new GetJobAtSchoolAction object. Sets action name, building, minActionTime, and ActionMethod (set to GetJobAtSchool method)
        /// </summary>
        /// <param name="_building"></param>
        public GetJobAtSchoolAction(Building _building)
        {
            Name = "get job at school";
            Building = _building;
            minActionTime = 5;
            //rateOfNeedIncrease = 1f;
            ActionMethod = GetJobAtSchool;
        ...
        /// <summary>
        /// Called each update frame for which action is ongoing. Simulates getting a job at school. Increments actionTimeElapsed and reduces EstTimeToFinish. If the elapsed action time is greater than the minimum action time and the affected need is fulfilled, Career attribute of person assigned to new instance of Teacher and CompleteAction method is called. 
        /// </summary>
        /// <param name="gameTime"></param>
        /// <param name="needs"></param>
        /// <param name="person"></param>
        public void GetJobAtSchool(GameTime gameTime, Dictionary<NeedNames, Need> needs, People person = null)
        {
            ...
            Console.WriteLine("getting job at school");

            if (actionTimeElapsed > minActionTime)
            {
                person.Career = new Teacher();
                CompleteAction();
            }
