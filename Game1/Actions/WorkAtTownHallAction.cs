...
namespace Game1.Actions
{
    ...
    class WorkAtTownHallAction : ActionAbstract
    {
        ...
        /// <summary>
        /// Called each update frame for which action is ongoing. Simulates working at town hall. Increments actionTimeElapsed and reduces EstTimeToFinish. If the elapsed action time is greater than the minimum action time and the affected need is fulfilled, CompleteAction method is called. 
        /// </summary>
