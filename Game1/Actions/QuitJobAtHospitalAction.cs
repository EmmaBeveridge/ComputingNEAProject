...
{
    /// <summary>
    /// Inherits from ActionAbstract to implement action to quit a job at the hospital
    /// </summary>
    class QuitJobAtHospitalAction : ActionAbstract
    {

        /// <summary>
        /// Constructor to create a new QuitJobAtHospitalAction object. Sets action name, building, minActionTime, and ActionMethod (set to QuitJobAtHospital method) 
        /// </summary>
        ...
        /// <summary>
        /// Called each update frame for which action is ongoing. Simulates quitting a job at hospital. Increments actionTimeElapsed and reduces EstTimeToFinish. If the elapsed action time is greater than the minimum action time and the affected need is fulfilled, Career attribute of person set to null and CompleteAction method is called. 
        /// </summary>
